const mr = Symbol("GPUContext.ownsDevice"), qs = (e) => e[mr] ?? !0;
function Ca(e) {
...
function so(e) {
  ...
  for (let r = 0; r < i; r++) {
    ...
    if (!Number.isFinite(o) || o < n)
      return t && Ri.set(t, !1), !1;
    n = o;
  }
  return t && Ri.set(t, !0), !0;
}
function La(e) {
  const t = Di.get(e);
...
function oc(e, t, n) {
  ...
  for (let Z = 0; Z < I; Z++) {
    ...
    _i(X, !1, r.theme), P.push(X);
  }
  const E = ic(r.theme.fontSize), z = ((Y = r.xAxis.name) == null ? void 0 : Y.trim()) ?? "";
  if (z.length > 0) {
    const Z = (R + D) / 2, J = m + r.theme.fontSize * 0.5, de = ((j = r.dataZoom) == null ? void 0 : j.some(($) => ($ == null ? void 0 : $.type) === "slider")) ?? !1 ? y - 32 : y, L = (J + de) / 2, X = e.addLabel(z, p + Z, M + L, {
      fontSize: E,
      color: r.theme.textColor,
      anchor: "middle"
    });
...
function lr(e, t, n, i, r, o = ko) {
  ...
  for (let T = 0; T < e.length; T++) {
    const A = e[T];
    (A == null ? void 0 : A.type) === "bar" && A.visible !== !1 && (y.push(A), p.push(T));
  }
  if (y.length > 0) {
    const T = ia(y, i);
  ...
  for (let T = 0; T < e.length; T++) {
    const A = e[T];
    A.type === "pie" || A.type === "candlestick" || A.visible !== !1 && (M.push(A), R.push(T));
  }
...
function Ic(e, t) {
  ...
  if (a && (e.xAxisRenderer.prepare(
    ...
    e.crosshairRenderer.prepare(c.x, c.y, o, R), e.crosshairRenderer.setVisible(!0);
  } else
    ...
    if (f) {
      ...
      if (R) {
        ...
        if (Number.isFinite(A) && Number.isFinite(b)) {
          ...
          e.highlightRenderer.prepare(v, I, Ac), e.highlightRenderer.setVisible(!0);
        } else
...
function Lc(e, t) {
  ...
  const A = i.map((m, x) => ({ series: m, originalIndex: x })).filter(({ series: m }) => m.visible !== !1), b = D.filter((m) => m.visible !== !1);
  return {
...
function Dl(e, t) {
  ...
  let m = null, x = null, w = 0, v = null, I = null, N = "", C = null, d = null, h = null, F = -1, S = 0, P = 0, B = 0, E = 0, z = 0, U = null, Y = 0, j = 0, q = 2, Z = !0, J = !1, re = new Uint32Array(0);
  const W = () => {
    ...
    m = e.createBuffer({
      ...
      size: 4,
      usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
    }), re = new Uint32Array(w), C = null, d = null, Z = !0;
  }, X = () => {
...
function Jl(e, t) {
  ...
  let y = null, p = 0, M = new ArrayBuffer(0), R = new Float32Array(M), D = 0, T = 0, A = null, b = !1, m = null, x = 0, w = new ArrayBuffer(0), v = new Float32Array(w);
  const I = () => {
...
function Du(e, t) {
  ...
  let u = 0, y = 0, p = { x: 0, y: 0, w: 0, h: 0 }, M = !1;
  const R = () => {
...
function $u(e, t) {
  ...
  const g = () => {
    ...
    if (!(n || i) && (i = !0, e.on("mousemove", y), e.on("mouseleave", p), e.canvas.addEventListener("wheel", M, { passive: !1 }), a)) {
      const v = e.canvas;
      l = v.style.touchAction, v.style.touchAction = "none", v.addEventListener("pointerdown", D, { passive: !1 }), v.addEventListener("pointermove", T, { passive: !1 }), v.addEventListener("pointerup", A), v.addEventListener("pointercancel", b);
    }
  }, x = () => {
    if (!(n || !i)) {
      if (i = !1, e.off("mousemove", y), e.off("mouseleave", p), e.canvas.removeEventListener("wheel", M), a) {
        const v = e.canvas;
...
function Jr(e, t, n, i, r, o) {
  ...
  const l = (u, y, p, M) => {
    ...
    const y = Qu(u), p = ef(u);
    if (!Number.isFinite(y) || !Number.isFinite(p)) return !1;
    const M = r.scale(y), R = r.scale(p);
    if (!Number.isFinite(M) || !Number.isFinite(R)) return !1;
...
function Qr(e, t, n, i, r) {
  ...
  for (let A = 0; A < u.length; A++) {
    ...
    typeof m == "number" && Number.isFinite(m) && m > 0 && b.visible !== !1 && (y += m, p++);
  }
  ...
  for (let A = 0; A < u.length; A++) {
    const b = u[A], m = b == null ? void 0 : b.value;
    if (typeof m != "number" || !Number.isFinite(m) || m <= 0 || (b == null ? void 0 : b.visible) === !1) continue;
    T++;
    const x = T === p;
    let v = m / y * mn;
...
function im() {
  ...
  const r = (s) => {
    ...
    for (let c = 0; c < s.length; c++) {
      const f = s[c];
      if (a.has(f))
        throw new Error(`Category domain must not contain duplicates. Duplicate: ${JSON.stringify(f)}`);
      a.set(f, c);
    }
    t = a;
  }, o = {
    ...
    range(s, a) {
      return $n("range min", s), $n("range max", a), n = s, i = a, o;
    },
    categoryIndex(s) {
      const a = t.get(s);
      return a === void 0 ? -1 : a;
...
function Ms(e, t) {
  const n = getComputedStyle(e), i = n.position, r = n.overflow, o = (t == null ? void 0 : t.clip) ?? !1, s = i === "static", a = !o && (r === "hidden" || r === "scroll" || r === "auto"), c = s ? e.style.position : null, f = a ? e.style.overflow : null;
...
const bf = "bgra8unorm", eo = 5, fr = 24 * 60 * 60 * 1e3, vf = 30 * fr, wf = 365 * fr, Cf = 9, Vr = 1, Mf = 6, dr = (e) => typeof e == "number" && Number.isFinite(e) ? e : null, gn = (e) => typeof e == "number" && Number.isFinite(e) ? e : void 0, Sf = 2e4, Ff = (e) => {
  ...
  for (let R = Cf; R >= Vr; R--) {
    const D = rr(y, p, R);
    let T = Number.NEGATIVE_INFINITY, A = !0;
...
function Of(e, t, n) {
  ...
  const r = e.preferredFormat ?? bf, o = n == null ? void 0 : n.pipelineCache, s = Yn(e.canvas) ? e.canvas.parentElement : null, a = s ? Ms(s) : null, c = s ? Ms(s, { clip: !0 }) : null, f = (k, O) => {
    if (y) return;
    const G = p.series;
    ...
    if (O !== void 0 && H.type === "pie") {
      ...
      const se = ie.map(
        (ne, Re) => Re === O ? { ...ne, visible: ne.visible === !1 } : ne
      ), he = G.map(
    ...
    const Q = G.map(
      (ie, se) => se === k ? { ...ie, visible: ie.visible === !1 } : ie
    );
    Ge({ ...p, series: Q });
  }, l = s && ((uo = t.legend) == null ? void 0 : uo.show) !== !1 ? cf(s, (fo = t.legend) == null ? void 0 : fo.position, f) : null, g = (() => {
  ...
  let y = !1, p = t, M = t.series.length, R = "pending", D = 0;
  const T = As();
  let A = null, b = !1;
  const m = As();
  ...
  const j = (k) => {
    if ((k.yAxis.autoBounds ?? "visible") !== "visible") return !1;
    const G = gn(k.yAxis.min), H = gn(k.yAxis.max);
    return !(G !== void 0 && H !== void 0);
  }, q = () => {
    j(p) ? Y = Uf(U) : Y = null;
  };
  let Z = [], J = !1, re = null, W = null, de = null, L = !1, X = !1;
  const $ = /* @__PURE__ */ new Map();
  let ue = new Array(p.series.length).fill("unknown");
  const ce = /* @__PURE__ */ new Set();
  let fe = s && ((mo = p.tooltip) == null ? void 0 : mo.show) !== !1 ? Ts(s) : null, K = null, ae = null, ee = null;
  const te = (k, O, G, H) => {
  ...
  const Wt = (k, O) => {
  ...
  }, Jt = (k) => k ? Number.isFinite(k.start) && Number.isFinite(k.end) && k.start <= 0 && k.end >= 100 : !0, Et = () => {
    re !== null && (cancelAnimationFrame(re), re = null), W !== null && (clearTimeout(W), W = null), J = !1;
  }, It = () => {
    ...
    if ($.size === 0) return !1;
    ce.clear();
    const k = (V == null ? void 0 : V.getRange()) ?? null, O = Jt(k), G = p.autoScroll === !0 && V != null && p.xAxis.min == null && p.xAxis.max == null, H = Tn(p, E), Q = k ? An(H, k) : null;
    let ie = !1;
    for (const [ne, Re] of $) {
      if (Re.length === 0) continue;
      const Se = p.series[ne];
      if (!(!Se || Se.type === "pie")) {
        if (ie = !0, Se.type === "candlestick") {
          let Me = B[ne];
          if (!Me) {
    ...
    return (se == null || Jt(se)) && (U = z, q()), !0;
  }, vn = (k) => {
    if (y) return;
    const O = (k == null ? void 0 : k.requestRenderAfter) ?? !0, G = bn(), H = (V == null ? void 0 : V.getRange()) ?? null, Q = Jt(H), ie = H != null && !Q;
    let se = !1;
    L ? (L = !1, It(), !H || Q ? (U = z, q()) : wt(), se = !0) : G && ie && (L = !1, It(), wt(), se = !0), (G || se) && O && vt();
  }, Kn = (k) => {
    y || J || (re !== null && (cancelAnimationFrame(re), re = null), W !== null && (clearTimeout(W), W = null), J = !0, re = requestAnimationFrame(() => {
      if (re = null, y) {
        Et();
        return;
      }
      W !== null && (clearTimeout(W), W = null), J = !1, vn();
    }), W = (typeof self < "u" ? self : window).setTimeout(() => {
      if (y) {
        Et();
        return;
      }
      J && (re !== null && (cancelAnimationFrame(re), re = null), J = !1, W = null, vn());
    }, 16));
  }, wi = () => {
    y || (It(), L = !1, de = (typeof self < "u" ? self : window).setTimeout(() => {
      de = null, !y && (L = !0, Kn());
    }, 100));
  }, Jn = (k, O) => {
    let G, H;
    ...
    for (let se = k.length - 1; se >= 0; se--) {
      const he = k[se];
      if (he.type !== "pie" || he.visible === !1) continue;
    ...
    for (let Q = k.length - 1; Q >= 0; Q--) {
      const ie = k[Q];
      if (ie.type !== "candlestick" || ie.visible === !1) continue;
      const se = ie, he = Kr(
        se,
        se.data,
        H.xScale,
    ...
    ct.source === "mouse" && (ct = { ...ct, isInGrid: !1, hasPointer: !1 }, ot.setVisible(!1), le(), kt(null, "mouse"), vt());
  };
  ...
  const cn = () => {
    ...
    if (k.length !== O.length) return !0;
    for (let G = 0; G < k.length; G++) {
      const H = k[G], Q = O[G];
      if (H.type !== Q.type) return !0;
      if (H.type === "pie") {
        const ie = H, se = Q;
        if (ie.data !== se.data || ie.data.length !== se.data.length) return !0;
      } else {
        const ie = H, se = Q, he = ie.rawData ?? ie.data, ne = se.rawData ?? se.data;
        if (he !== ne || he.length !== ne.length) return !0;
      }
    }
    return !1;
  }, Ge = (k) => {
    ...
    if (p = k, H && (z = k.series, U = k.series, ue = new Array(k.series.length).fill("unknown"), Z = new Array(k.series.length).fill(null), It(), L = !1, Et(), st()), Y = null, l == null || l.update(k.series, k.theme), Ct(), ze(), wt(), s) {
      const nt = ((en = p.tooltip) == null ? void 0 : en.show) !== !1;
    ...
    if (qe.ensureAreaRendererCount(Q), qe.ensureLineRendererCount(Q), qe.ensureScatterRendererCount(Q), qe.ensureScatterDensityRendererCount(Q), qe.ensurePieRendererCount(Q), qe.ensureCandlestickRendererCount(Q), Q < M)
      for (let nt = Q; nt < M; nt++)
        pe.removeSeries(nt);
    if (M = Q, p.animation === !1 && R === "running" && (T.cancelAll(), A = null, R = "done", D = 1), p.animation === !1) {
      Bt(), vt();
      return;
    }
  ...
  return {
    ...
    setInteractionX: (k, O) => {
      cn();
      const G = k !== null && Number.isFinite(k) ? k : null;
      ct = { ...ct, source: G === null ? "mouse" : "sync" }, kt(G, O), G === null && ct.hasPointer === !1 && (ot.setVisible(!1), ve.setVisible(!1), be()), vt();
    },
    ...
    render: () => {
      ...
      ($.size > 0 || L) && (Et(), vn({ requestRenderAfter: !1 })), X && (X = !1, an());
        ...
        const Ve = Gf(p.animation), Ze = (() => {
          for (let Gt = 0; Gt < O.length; Gt++) {
            ...
            switch (tt.type) {
              ...
              case "bar":
              case "scatter": {
                if (Ne(tt.data) > 0) return !0;
                break;
              }
              case "candlestick": {
                if (tt.data.length > 0) return !0;
                break;
              }
              default:
                Ff(tt);
      ...
      ), ht.hasPointer && ht.isInGrid && ((bo = p.tooltip) == null ? void 0 : bo.show) !== !1) {
        const Ve = e.canvas;
        if (Je && Ve && Yn(Ve)) {
      ...
      ve.render(ci), k && (Le.render(ci), rt.render(ci)), ot.render(ci), ci.end(), i.queue.submit([si.finish()]), b = !0, oc(a, s, {
        gpuContext: e,
        currentOptions: p,
        xScale: Se,
        yScale: Me,
    ...
    dispose: () => {
      if (!y) {
        ...
        x = null, w = 1, v = null, Et(), It(), L = !1, $.clear(), oe == null || oe.dispose(), oe = null, ge == null || ge(), ge = null, V = null, we = null, me.clear(), ke == null || ke.dispose(), ot.dispose(), ve.dispose(), qe.dispose(), Be.dispose(), Le.dispose(), rt.dispose(), Te.dispose(), Xe.dispose(), Ke.dispose(), We.dispose(), mt.dispose(), pe.dispose(), fe == null || fe.dispose(), fe = null, l == null || l.dispose(), a == null || a.dispose(), c == null || c.dispose();
      }
    }
  };
}
...
function ya(e = {}) {
  var A, b, m, x;
  const t = jf(e.theme), n = e.autoScroll, i = typeof n == "boolean" ? n : Rt.autoScroll, r = e.animation, s = (typeof r == "boolean" || r !== null && typeof r == "object" && !Array.isArray(r) ? r : void 0) ?? !0, a = mi(e.palette), c = a.length > 0 ? { ...t, colorPalette: a } : t, f = mi(c.colorPalette), l = f.length > 0 ? f : mi(Rt.palette ?? or).length > 0 ? mi(Rt.palette ?? or) : Array.from(or), g = l.length > 0 ? l : ["#000000"], u = { ...c, colorPalette: g.slice() }, y = {
    ...
    const I = (w == null ? void 0 : w.show) !== !1, N = Zt(w == null ? void 0 : w.color) ?? v.gridLineColor, C = typeof (w == null ? void 0 : w.opacity) == "number" && Number.isFinite(w.opacity) ? Math.min(1, Math.max(0, w.opacity)) : 1, d = (S, P) => {
      if (P === 1) return S;
      const B = yt(S);
      return B ? `rgba(${Math.round(B[0] * 255)}, ${Math.round(B[1] * 255)}, ${Math.round(B[2] * 255)}, ${B[3] * P})` : S;
    }, h = d(N, C), F = (S, P) => {
      if (S === !1)
        return { show: !1, count: 0, color: h };
      if (S === !0 || S === void 0)
        return { show: I, count: P, color: h };
      const B = S.show !== !1 && I, E = typeof S.count == "number" && Number.isFinite(S.count) && S.count >= 0 ? Math.floor(S.count) : P, z = Zt(S.color), U = z != null ? d(z, C) : h;
    ...
    const I = Zt(w.color), N = u.colorPalette[v % u.colorPalette.length], C = I ?? N, d = w.visible !== !1, h = Kf(w.sampling) ?? "lttb", F = Us(w.samplingThreshold) ?? 5e3;
    switch (w.type) {
      case "area": {
      ...
      case "pie": {
        const { sampling: J, samplingThreshold: re, ...W } = w, de = (w.data ?? []).map((L, X) => {
          const $ = Zt(L == null ? void 0 : L.color), ue = u.colorPalette[(v + X) % u.colorPalette.length], ce = (L == null ? void 0 : L.visible) !== !1;
          return {
            ...L,
            color: $ ?? ue,
            visible: ce
...
const rm = { resolve: ya }, no = (e, t, n) => Math.min(n, Math.max(t, e)), fd = (e) => {
  let { start: t, end: n } = e;
  if (t > n) {
    const i = t;
    t = n, n = i;
...
function dd(e, t, n) {
  ...
  const R = (d) => {
    ...
    let E = !1;
    const z = () => {
      E || (E = !0, window.removeEventListener("pointermove", B), window.removeEventListener("pointerup", U), window.removeEventListener("pointercancel", U), h === "pan-window" && (l.style.cursor = "grab", y.style.cursor = "grab"), b(P, d.pointerId), M === z && (M = null));
    }, U = (Y) => {
      Y.pointerId === d.pointerId && z();
    };
    M = z, window.addEventListener("pointermove", B, { passive: !1 }), window.addEventListener("pointerup", U, { passive: !0 }), window.addEventListener("pointercancel", U, { passive: !0 });
  }, x = (d) => m(d, "left-handle"), w = (d) => m(d, "right-handle"), v = (d) => m(d, "pan-window");
  g.addEventListener("pointerdown", x, { passive: !1 }), u.addEventListener("pointerdown", w, { passive: !1 }), y.addEventListener("pointerdown", v, { passive: !1 });
...
function hd(e, t, n) {
  ...
  return e.appendChild(o), {
    ...
    dispose() {
      if (!i) {
        i = !0, o.removeEventListener("click", c);
        try {
          f();
        } catch {
        }
...
Resources:
  ...
  const r = !!n;
  let o = !1, s = t.renderMode ?? "auto", a = !1, c = !1, f = null, l = null, g = null, u = null, y = null, p, M = !1, R = null, D = null, T = null, A = t, b = Vs(A), m = new Array(b.series.length).fill(null).map(() => ({ x: [], y: [] })), x = new Array(b.series.length).fill(null), w = null;
  const v = () => {
  ...
  let h = !1, F = null, S = null, P = null;
  const B = /* @__PURE__ */ new Set();
  let E = null, z = null, U = !0;
  ...
  const $ = /* @__PURE__ */ new Set(), ue = () => d.mouseover.size > 0 || d.mouseout.size > 0, ce = () => d.click.size > 0, fe = () => {
    ...
    o || (U = !0, s !== "external" && E === null && (E = requestAnimationFrame(() => {
      E = null, !o && ae(!0);
    })));
  }, te = () => {
    if (u)
    ...
    te(), be(), le(), Ke(), l == null || l.dispose(), M = !1, p = void 0;
    const V = {
      onRequestRender: ee,
    ...
    xe && Pe && Ce && (me || !z || z.width !== i.width || z.height !== i.height || z.format !== Ce) && (Pe.configure({
      ...
      format: Ce,
      alphaMode: "opaque"
    }), z = { width: i.width, height: i.height, format: Ce }, et = !0, l && g !== Ce && Vt()), _ && (me || et) && ee();
  }, _t = () => gt(!0), Wt = (_) => {
    const V = i.getBoundingClientRect();
    if (!(V.width > 0) || !(V.height > 0)) return { match: null, isInGrid: !1 };
    ...
    if (!(me > 0) || !(xe > 0)) return { match: null, isInGrid: !1 };
    const Pe = oe - we, Ce = ge - Ie;
    if (!(Pe >= 0 && Pe <= me && Ce >= 0 && Ce <= xe)) return { match: null, isInGrid: !1 };
    ...
    const Bt = C, Qt = (() => {
      ...
      for (let Oe = b.series.length - 1; Oe >= 0; Oe--) {
        ...
        if (pt.type !== "pie" || pt.visible === !1) continue;
    ...
    if (Qt) return { match: Qt, isInGrid: !0 };
    for (let Ge = b.series.length - 1; Ge >= 0; Ge--) {
      const Oe = b.series[Ge];
      if ((Oe == null ? void 0 : Oe.type) !== "candlestick" || Oe.visible === !1) continue;
  ...
  i.addEventListener("pointermove", Kn, { passive: !0 }), i.addEventListener("pointerleave", wi, { passive: !0 }), i.addEventListener("pointercancel", Jn, { passive: !0 }), i.addEventListener("lostpointercapture", Ci, { passive: !0 }), i.addEventListener("pointerdown", wn, { passive: !0 }), i.addEventListener("pointerup", Mi, { passive: !0 });
  const Qn = () => {
    if (!o) {
      o = !0;
      try {
        ...
        F = null, S = null, P = null, C = null, M = !1, p = void 0, i.removeEventListener("pointermove", Kn), i.removeEventListener("pointerleave", wi), i.removeEventListener("pointercancel", Jn), i.removeEventListener("lostpointercapture", Ci), i.removeEventListener("pointerdown", wn), i.removeEventListener("pointerup", Mi), d.click.clear(), d.mouseover.clear(), d.mouseout.clear(), d.crosshairMove.clear(), d.zoomRangeChange.clear(), d.deviceLost.clear(), d.dataAppend.clear(), h = !1, f = null, i.remove();
      }
    }
  }, ei = {
    get options() {
      ...
      if (oe.type === "candlestick") {
        ...
        if (Pe) {
          ...
          for (let Ue = 0; Ue < ge; Ue++) {
            ...
            const st = at(xe, Ue);
            St[Ue] = st, st !== void 0 && (et = !0), h && Number.isFinite(ze) && (ze < we && (we = ze), ze > Ie && (Ie = ze));
          }
    ...
    renderFrame() {
      if (o || c) return !1;
      if (s === "auto")
        return console.warn('renderFrame() called in auto mode - this is a no-op. Set renderMode to "external" to use manual rendering.'), !1;
      if (a || !l || !(f != null && f.device) || !U) return !1;
      try {
        return ae(!1), !0;
      } catch {
        return !1;
    ...
    setZoomRange(_, V, oe) {
      ...
      if (!ge) return;
      M = !0, p = oe, l.setZoomRange(_, V);
      const we = l.getZoomRange();
      (!we || we.start === ge.start && we.end === ge.end) && (M = !1, p = void 0);
    },
...
function om(e, t) {
  ...
  let o = !1;
  const s = [];
  let a = !1, c = null, f = !1, l = 0, g = 100;
  const u = (p, M) => {
    if (!(a && M === c)) {
      a = !0, c = M;
      for (const R of e)
        R !== p && (R.disposed || R.setCrosshairX(M, r));
    }
  }, y = (p, M, R) => {
    if (!(f && M === l && R === g)) {
      f = !0, l = M, g = R;
      for (const D of e)
        D !== p && (D.disposed || D.setZoomRange(M, R, r));
    }
  };
  for (const p of e)
    if (!p.disposed) {
      if (n) {
        const M = (D) => {
          o || D.source !== r && (p.disposed || u(p, D.x));
        };
        p.on("crosshairMove", M);
        const R = () => p.off("crosshairMove", M);
        s.push(R);
      }
      if (i) {
        const M = (D) => {
          o || D.source !== r && D.sourceKind !== "auto-scroll" && (p.disposed || y(p, D.start, D.end));
        };
        p.on("zoomRangeChange", M);
        const R = () => p.off("zoomRangeChange", M);
        s.push(R);
      }
    }
  return () => {
...
function Pd(e, t, n = {}) {
  ...
  let s = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), c = !1;
  const f = (d) => Array.isArray(d), l = (d) => Array.isArray(d), g = (d) => f(d) ? d[0] : d.x, u = (d) => f(d) ? d[1] : d.y, y = (d) => l(d) ? d[0] : d.timestamp, p = (d) => l(d) ? d[2] : d.high, M = (d) => l(d) ? d[3] : d.low;
  function R() {
    var P, B;
    const d = e.options;
    let h = (P = d.xAxis) == null ? void 0 : P.min, F = (B = d.xAxis) == null ? void 0 : B.max;
    if (h === void 0 || F === void 0) {
      const E = d.series ?? [];
      let z = Number.POSITIVE_INFINITY, U = Number.NEGATIVE_INFINITY;
      for (const Y of E)
        if (Y.type !== "pie")
          if (Y.type === "candlestick") {
            const j = Y.data;
            for (const q of j) {
              const Z = y(q);
              Z < z && (z = Z), Z > U && (U = Z);
      ...
      h === void 0 && (h = Number.isFinite(z) ? z : 0), F === void 0 && (F = Number.isFinite(U) ? U : 100);
    }
    const S = e.getZoomRange();
    if (S) {
      const E = F - h, z = h + S.start / 100 * E, U = h + S.end / 100 * E;
      return { min: z, max: U };
    }
    return { min: h, max: F };
  }
  function D() {
    var S, P;
    const d = e.options;
    let h = (S = d.yAxis) == null ? void 0 : S.min, F = (P = d.yAxis) == null ? void 0 : P.max;
    if (h === void 0 || F === void 0) {
      const B = d.series ?? [];
      let E = Number.POSITIVE_INFINITY, z = Number.NEGATIVE_INFINITY;
      for (const U of B)
        if (U.type !== "pie")
          if (U.type === "candlestick") {
            const Y = U.data;
            for (const j of Y) {
              const q = p(j), Z = M(j);
              q > z && (z = q), Z < E && (E = Z);
      ...
      h === void 0 && (h = Number.isFinite(E) ? E : 0), F === void 0 && (F = Number.isFinite(z) ? z : 100);
    }
    return { min: h, max: F };
  }
  function T(d, h) {
    const F = e.options, S = t.getBoundingClientRect(), P = F.grid ?? { left: 60, right: 20, top: 40, bottom: 40 }, B = S.width, E = S.height, z = P.left ?? 60, U = B - (P.right ?? 20), Y = P.top ?? 40, j = E - (P.bottom ?? 40), q = U - z, Z = j - Y, J = F.xAxis, re = F.yAxis;
    let W = 0, de = 0;
    if (d !== void 0 && J)
      if (J.type === "category" && Array.isArray(J.data)) {
        const L = J.data, X = L.indexOf(String(d));
        if (X >= 0) {
          const $ = X / (L.length - 1 || 1);
          W = z + $ * q;
        }
      } else {
        const L = R(), X = L.min, $ = L.max, ue = (d - X) / ($ - X || 1);
        W = z + ue * q;
      }
    if (h !== void 0 && re) {
      const L = D(), X = L.min, $ = L.max, ue = (h - X) / ($ - X || 1);
      de = j - ue * Z;
    }
    return { x: W, y: de };
  }
  function A(d, h) {
    const F = e.options, S = t.getBoundingClientRect(), P = F.grid ?? { left: 60, right: 20, top: 40, bottom: 40 }, B = S.width, E = S.height, z = P.left ?? 60, U = B - (P.right ?? 20), Y = P.top ?? 40, j = E - (P.bottom ?? 40), q = U - z, Z = j - Y;
    return {
      x: z + d * q,
      y: Y + h * Z
    };
  ...
  function b(d) {
    s.clear(), d.forEach((h, F) => {
      const S = {};
      if (h.type === "lineX" && h.x !== void 0) {
        const { x: P } = T(h.x, void 0);
        S.canvasX = P;
      } else if (h.type === "lineY" && h.y !== void 0) {
        const { y: P } = T(void 0, h.y);
        S.canvasY = P;
      } else if (h.type === "point" && h.x !== void 0 && h.y !== void 0) {
        const { x: P, y: B } = T(h.x, h.y);
        S.canvasX = P, S.canvasY = B;
      } else if (h.type === "text") {
        const P = h.position;
        if (P.space === "plot") {
          const { x: B, y: E } = A(P.x, P.y);
          S.canvasX = B, S.canvasY = E;
        } else if (P.space === "data") {
          const { x: B, y: E } = T(P.x, P.y);
          S.canvasX = B, S.canvasY = E;
        }
      }
      s.set(F, S);
  ...
  function m(d, h, F, S) {
    return F !== void 0 ? Math.abs(d - F) : S !== void 0 ? Math.abs(h - S) : 1 / 0;
  }
  function x(d, h, F, S) {
    const P = d - F, B = h - S;
  ...
  function w(d, h, F, S) {
    return d >= F.left - S && d <= F.right + S && h >= F.top - S && h <= F.bottom + S;
  }
  function v(d, h) {
    const F = e.options.annotations ?? [];
    if (F.length === 0)
      return null;
    c || b(F);
    let S = null, P = 1 / 0;
    for (let B = 0; B < F.length; B++) {
      const E = F[B], z = s.get(B);
      if (z) {
        if (E.type === "lineX" && z.canvasX !== void 0) {
          const U = m(d, h, z.canvasX, void 0);
          U <= i && U < P && (P = U, S = {
            annotationIndex: B,
            annotation: E,
            hitType: "line",
        ...
        } else if (E.type === "lineY" && z.canvasY !== void 0) {
          const U = m(d, h, void 0, z.canvasY);
          U <= i && U < P && (P = U, S = {
            annotationIndex: B,
            annotation: E,
            hitType: "line",
    ...
    for (let B = 0; B < F.length; B++) {
      const E = F[B], z = a.get(B);
      if (E.type === "text" && z && w(d, h, z, r)) {
        const U = z.left + z.width / 2, Y = z.top + z.height / 2, j = x(d, h, U, Y);
        j < P && (P = j, S = {
          annotationIndex: B,
          annotation: E,
          hitType: "text",
    ...
    for (let B = 0; B < F.length; B++) {
      const E = F[B], z = s.get(B);
      if (z && E.type === "point" && z.canvasX !== void 0 && z.canvasY !== void 0) {
        const U = x(d, h, z.canvasX, z.canvasY);
        U <= o && U < P && (P = U, S = {
          annotationIndex: B,
          annotation: E,
          hitType: "point",
...
function Rd(e, t, n) {
  let i = null;
  const r = (w) => Array.isArray(w), o = (w) => Array.isArray(w), s = (w) => r(w) ? w[0] : w.x, a = (w) => r(w) ? w[1] : w.y, c = (w) => o(w) ? w[0] : w.timestamp, f = (w) => o(w) ? w[2] : w.high, l = (w) => o(w) ? w[3] : w.low;
  function g() {
    var C, d;
    const w = e.options;
    let v = (C = w.xAxis) == null ? void 0 : C.min, I = (d = w.xAxis) == null ? void 0 : d.max;
    if (v === void 0 || I === void 0) {
      ...
      v === void 0 && (v = Number.isFinite(F) ? F : 0), I === void 0 && (I = Number.isFinite(S) ? S : 100);
    }
    const N = e.getZoomRange();
    if (N) {
      const h = I - v, F = v + N.start / 100 * h, S = v + N.end / 100 * h;
      return { min: F, max: S };
    }
    return { min: v, max: I };
  }
  function u() {
    var N, C;
    const w = e.options;
    let v = (N = w.yAxis) == null ? void 0 : N.min, I = (C = w.yAxis) == null ? void 0 : C.max;
    if (v === void 0 || I === void 0) {
      const d = w.series ?? [];
      ...
      v === void 0 && (v = Number.isFinite(h) ? h : 0), I === void 0 && (I = Number.isFinite(F) ? F : 100);
    }
    return { min: v, max: I };
  }
  function y(w, v) {
    const I = e.options, N = t.getBoundingClientRect(), C = I.grid ?? { left: 60, right: 20, top: 40, bottom: 40 }, d = N.width, h = N.height, F = C.left ?? 60, S = d - (C.right ?? 20), P = C.top ?? 40, B = h - (C.bottom ?? 40), E = S - F, z = B - P, U = I.xAxis, Y = I.yAxis;
    let j = 0, q = 0;
    if (U) {
      const Z = (w - F) / E;
      if (U.type === "category" && Array.isArray(U.data)) {
        const J = U.data, re = Math.round(Z * (J.length - 1 || 1));
        j = J[Math.max(0, Math.min(re, J.length - 1))];
      } else {
        const J = g();
        j = J.min + Z * (J.max - J.min);
      }
    }
    if (Y) {
      const Z = (B - v) / z, J = u();
      q = J.min + Z * (J.max - J.min);
    }
    return { x: j, y: q };
  }
  function p(w, v) {
    const I = e.options, N = t.getBoundingClientRect(), C = I.grid ?? { left: 60, right: 20, top: 40, bottom: 40 }, d = N.width, h = N.height, F = C.left ?? 60, S = d - (C.right ?? 20), P = C.top ?? 40, B = h - (C.bottom ?? 40), E = S - F, z = B - P, U = (w - F) / E, Y = (v - P) / z;
    return {
  ...
  function M(w) {
    if (!i)
      return;
    w.preventDefault();
    const v = t.getBoundingClientRect(), I = w.clientX - v.left, N = w.clientY - v.top, C = i.annotation, d = {};
    if (C.type === "lineX") {
      const { x: h } = y(I, 0);
      d.x = h;
    } else if (C.type === "lineY") {
      const { y: h } = y(0, N);
      d.y = h;
    } else if (C.type === "text") {
      const h = C.position.space;
      if (h === "plot") {
        const { x: F, y: S } = p(I, N);
        d.position = { space: h, x: F, y: S };
      } else {
        const { x: F, y: S } = y(I, N);
        d.position = { space: h, x: F, y: S };
      }
    ...
    n.onDragMove(i.annotationIndex, d);
  }
  function R(w) {
    if (!i) return;
    const v = t.getBoundingClientRect(), I = w.clientX - v.left, N = w.clientY - v.top, C = i.annotation, d = {};
    ...
    n.onDragEnd(i.annotationIndex, d), A();
  }
  function D() {
    i && (n.onDragCancel(), A());
  }
  function T(w) {
    i && w.key === "Escape" && (w.preventDefault(), D());
  }
  function A() {
    if (i) {
      if (window.removeEventListener("pointermove", M), window.removeEventListener("pointerup", R), window.removeEventListener("pointercancel", D), document.removeEventListener("keydown", T), i.pointerId !== null)
        try {
  ...
  function b(w, v, I, N) {
    i && A(), i = {
      ...
      startPointerY: N,
      pointerId: null
    }, v.type === "lineX" ? document.body.style.cursor = "ew-resize" : v.type === "lineY" ? document.body.style.cursor = "ns-resize" : document.body.style.cursor = "grabbing", window.addEventListener("pointermove", M, { passive: !1 }), window.addEventListener("pointerup", R, { passive: !0 }), window.addEventListener("pointercancel", D, { passive: !0 }), document.addEventListener("keydown", T, { passive: !1 }), n.onDragMove(w, {
      style: { ...v.style, opacity: 0.7 }
    });
  }
  function m() {
    return i !== null;
...
function Ed(e, t = {}) {
  const n = t.palette ?? Dd, i = t.zIndex ?? 1e3;
  let r = null, o = null, s = null, a = null, c = "create";
  function f() {
  ...
  function g(d, h) {
    ...
    return S.textContent = d, S.style.cssText = `
      display: block;
      margin-bottom: 8px;
      font-size: 13px;
      font-weight: 500;
      color: #b0b0b0;
    `, F.appendChild(S), F.appendChild(h), F;
  }
  function u(d, h, F = "") {
    const S = document.createElement("input");
    return S.type = "text", S.placeholder = d, S.maxLength = h, S.value = F, S.style.cssText = `
      width: 100%;
      padding: 8px 12px;
      background: #2a2a3e;
  ...
  function y(d, h, F = "") {
    ...
    return S.placeholder = d, S.maxLength = h, S.value = F, S.rows = 3, S.style.cssText = `
      width: 100%;
      padding: 8px 12px;
      background: #2a2a3e;
      border: 1px solid #444;
  ...
  function p(d) {
    ...
    return n.forEach((S) => {
      ...
      P.type = "button", P.dataset.color = S, P.style.cssText = `
        position: relative;
        width: 100%;
        aspect-ratio: 1;
        background: ${S};
        ...
        box-shadow: ${S === F ? "inset 0 0 0 2px #ffffff, inset 0 0 0 3px rgba(0, 0, 0, 0.3), 0 2px 8px rgba(0, 0, 0, 0.3)" : "inset 0 0 0 1px rgba(255, 255, 255, 0.1)"};
        transform: ${S === F ? "scale(1.05)" : "scale(1)"};
      `;
      const B = document.createElementNS("http://www.w3.org/2000/svg", "svg");
      B.setAttribute("viewBox", "0 0 24 24"), B.setAttribute("fill", "none"), B.style.cssText = `
        position: absolute;
        top: 50%;
        left: 50%;
      ...
      `, B.appendChild(E), P.appendChild(B), P.addEventListener("click", () => {
        F = S, Array.from(h.children).forEach((z) => {
          const U = z, j = U.dataset.color === S;
          U.style.boxShadow = j ? "inset 0 0 0 2px #ffffff, inset 0 0 0 3px rgba(0, 0, 0, 0.3), 0 2px 8px rgba(0, 0, 0, 0.3)" : "inset 0 0 0 1px rgba(255, 255, 255, 0.1)", U.style.transform = j ? "scale(1.05)" : "scale(1)";
          const q = U.querySelector("svg");
          q && (q.style.opacity = j ? "1" : "0");
        });
      }), P.addEventListener("mouseenter", () => {
        S !== F && (P.style.transform = "scale(1.1)", P.style.boxShadow = "inset 0 0 0 2px rgba(255, 255, 255, 0.2), 0 4px 12px rgba(0, 0, 0, 0.4)");
      }), P.addEventListener("mouseleave", () => {
        S !== F && (P.style.transform = "scale(1)", P.style.boxShadow = "inset 0 0 0 1px rgba(255, 255, 255, 0.1)");
      }), h.appendChild(P);
    }), {
      container: h,
      getValue: () => F
  ...
  function M(d, h) {
    ...
    `, d.forEach((S) => {
      ...
      P.value = S.value, P.textContent = S.label, S.value === h && (P.selected = !0), F.appendChild(P);
    }), {
      container: F,
      getValue: () => F.value
    };
  }
  function R(d, h, F, S, P = "") {
    ...
    E.type = "range", E.min = String(d), E.max = String(h), E.step = String(F), E.value = String(S), E.style.cssText = `
      flex: 1;
      cursor: pointer;
    `;
    const z = document.createElement("span");
    return z.textContent = `${S}${P}`, z.style.cssText = `
      min-width: 40px;
      text-align: right;
      font-size: 13px;
      color: #b0b0b0;
    `, E.addEventListener("input", () => {
      z.textContent = `${E.value}${P}`;
    }), B.appendChild(E), B.appendChild(z), {
      container: B,
  ...
  function D(d, h, F) {
    ...
    `;
    const P = document.createElement("button");
    P.type = "button", P.textContent = "Cancel", P.style.cssText = `
      padding: 8px 16px;
    ...
    return B.type = "button", B.textContent = d, B.style.cssText = `
      padding: 8px 16px;
      background: #2a2a3e;
      border: 1px solid #444;
      border-radius: 4px;
    ...
    `, B.addEventListener("mouseenter", () => {
      B.style.background = "#3a3a4e";
    }), B.addEventListener("mouseleave", () => {
      B.style.background = "#2a2a3e";
    }), B.addEventListener("click", h), S.appendChild(P), S.appendChild(B), S;
  }
  function T(d) {
    var U, Y, j, q;
    const h = document.createElement("div"), F = ((U = d.label) == null ? void 0 : U.text) ?? "", S = u("Line label", 100, F), P = p(((Y = d.style) == null ? void 0 : Y.color) ?? n[0]), B = M(
      [
        { label: "Solid", value: "solid" },
        { label: "Dashed", value: "dashed" },
        { label: "Dotted", value: "dotted" }
      ],
      (j = d.style) != null && j.lineDash ? d.style.lineDash.length === 4 ? "dashed" : "dotted" : "solid"
    ), E = R(1, 8, 1, ((q = d.style) == null ? void 0 : q.lineWidth) ?? 2, "px");
    h.appendChild(g("Label (optional)", S)), h.appendChild(g("Color", P.container)), h.appendChild(g("Line Style", B.container)), h.appendChild(g("Line Width", E.container));
    const z = D(
    ...
    return h.appendChild(z), h;
  }
  function A(d) {
    var E;
    const h = document.createElement("div"), F = d.text ?? "", S = y("Text content", 500, F), P = p(((E = d.style) == null ? void 0 : E.color) ?? n[0]);
    h.appendChild(g("Text", S)), h.appendChild(g("Color", P.container));
    const B = D(
      c === "create" ? "Create" : "Save",
      () => {
        const z = S.value.trim();
        if (!z) {
  ...
  function b(d) {
    var U, Y, j, q, Z;
    const h = document.createElement("div"), F = ((U = d.label) == null ? void 0 : U.text) ?? "", S = u("Point label", 100, F), P = p(((Y = d.style) == null ? void 0 : Y.color) ?? n[0]), B = ((j = d.marker) == null ? void 0 : j.size) ?? ((Z = (q = d.marker) == null ? void 0 : q.style) == null ? void 0 : Z.markerSize) ?? 8, E = R(4, 16, 1, B, "px");
    h.appendChild(g("Label (optional)", S)), h.appendChild(g("Color", P.container)), h.appendChild(g("Marker Size", E.container));
    const z = D(
      c === "create" ? "Create" : "Save",
      () => {
        var W;
        const J = S.value.trim(), re = {
          ...d,
          label: J ? {
            ...d.label,
            text: J
          ...
          marker: {
            ...
            size: E.getValue(),
            style: {
              ...(W = d.marker) == null ? void 0 : W.style,
              color: P.getValue()
            }
          }
        };
  ...
  function v(d, h, F, S) {
    c = "create", s = F, a = S, r = f(), o = l();
    const P = document.createElement("h3");
    P.textContent = `Add ${d === "lineX" ? "Vertical Line" : d === "lineY" ? "Horizontal Line" : d === "text" ? "Text Note" : "Point Marker"}`, P.style.cssText = `
      margin: 0 0 20px 0;
      font-size: 16px;
      font-weight: 600;
      color: #ffffff;
    `, o.appendChild(P);
    let B;
    d === "lineX" || d === "lineY" ? B = T(h) : d === "text" ? B = A(h) : B = b(h), o.appendChild(B), r.appendChild(o), e.appendChild(r), document.addEventListener("keydown", w);
    const E = o.querySelector("input, textarea");
    E && setTimeout(() => E.focus(), 50);
  }
  function I(d, h, F) {
    c = "edit", s = h, a = F, r = f(), o = l();
    const S = document.createElement("h3");
    S.textContent = "Edit Annotation", S.style.cssText = `
      margin: 0 0 20px 0;
      font-size: 16px;
      font-weight: 600;
      color: #ffffff;
    `, o.appendChild(S);
    let P;
    d.type === "lineX" || d.type === "lineY" ? P = T(d) : d.type === "text" ? P = A(d) : P = b(d), o.appendChild(P), r.appendChild(o), e.appendChild(r), document.addEventListener("keydown", w);
    const B = o.querySelector("input, textarea");
    B && setTimeout(() => B.focus(), 50);
  }
  function N() {
    r && r.parentNode && r.parentNode.removeChild(r), r = null, o = null, s = null, a = null, document.removeEventListener("keydown", w);
  }
  function C() {
    N();
  }
...
const ga = (e) => Array.isArray(e), io = (e) => Array.isArray(e), Bd = (e) => ga(e) ? e[0] : e.x, Ld = (e) => ga(e) ? e[1] : e.y, _d = (e) => io(e) ? e[0] : e.timestamp;
function sm(e, t, n = {}) {
  const {
    menuZIndex: i = 1e3,
    enableContextMenu: r = !0
  } = n, o = e.querySelector("canvas");
  if (!o)
    throw new Error("createAnnotationAuthoring: canvas element not found in container");
  let s = [{ annotations: t.options.annotations ?? [] }], a = 0, c = !1;
  const f = Pd(t, o, {
    lineTolerance: 20,
    textTolerance: 8,
    pointTolerance: 16
    ...
    onDragMove: (L, X) => {
      const ue = u().map((ce, fe) => fe === L ? { ...ce, ...X } : ce);
      p(ue);
    },
    onDragEnd: (L, X) => {
      const ue = u().map((ce, fe) => fe === L ? { ...ce, ...X } : ce);
  ...
  }), u = () => t.options.annotations ?? [], y = (L) => {
    s = s.slice(0, a + 1), s.push({ annotations: [...L] }), a = s.length - 1, s.length > 50 && (s.shift(), a--);
  }, p = (L) => {
    t.setOption({
      ...t.options,
      annotations: [...L]
  ...
  const R = () => {
    const L = document.createElement("div");
    return L.style.position = "fixed", L.style.display = "none", L.style.backgroundColor = "#1a1a2e", L.style.border = "1px solid #333", L.style.borderRadius = "8px", L.style.boxShadow = "0 4px 12px rgba(0, 0, 0, 0.5)", L.style.zIndex = String(i), L.style.minWidth = "180px", L.style.padding = "6px 0", L.style.fontFamily = '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', L.style.fontSize = "14px", L.style.color = "#e0e0e0", document.body.appendChild(L), L;
  }, D = (L, X) => {
    const $ = document.createElement("div");
    return $.textContent = L, $.style.padding = "8px 16px", $.style.cursor = "pointer", $.style.transition = "background-color 0.15s", $.style.userSelect = "none", $.addEventListener("mouseenter", () => {
    ...
    const L = document.createElement("div");
    return L.style.height = "1px", L.style.backgroundColor = "#333", L.style.margin = "6px 0", L;
  }, A = (L, X, $) => {
    L.innerHTML = "", L.appendChild(D("Edit annotation...", () => S(X, $))), L.appendChild(D("Delete annotation", () => P(X))), L.appendChild(T()), L.appendChild(D("Add vertical line here", () => d())), L.appendChild(D("Add horizontal line here", () => h())), L.appendChild(D("Add text note here", () => F()));
  }, b = (L) => {
    L.innerHTML = "", L.appendChild(D("Add vertical line here", () => d())), L.appendChild(D("Add horizontal line here", () => h())), L.appendChild(D("Add text note here", () => F()));
  };
  let m = null;
  const x = (L) => {
    if (!M) return;
    m = t.hitTest(L);
    const X = o.getBoundingClientRect(), $ = L.clientX - X.left, ue = L.clientY - X.top, ce = f.hitTest($, ue);
    ce ? A(M, ce.annotationIndex, ce.annotation) : b(M), M.style.display = "block", M.style.left = `${L.clientX}px`, M.style.top = `${L.clientY}px`, requestAnimationFrame(() => {
      if (!M || M.style.display !== "block") return;
      const fe = M.getBoundingClientRect();
      let K = L.clientX, ae = L.clientY;
      fe.right > window.innerWidth && (K = Math.max(0, L.clientX - fe.width)), fe.bottom > window.innerHeight && (ae = Math.max(0, L.clientY - fe.height)), (K !== L.clientX || ae !== L.clientY) && (M.style.left = `${K}px`, M.style.top = `${ae}px`);
    });
  }, w = () => {
    M && (M.style.display = "none", m = null);
  }, v = () => {
    var ce, fe;
    const L = t.options;
    let X = (ce = L.xAxis) == null ? void 0 : ce.min, $ = (fe = L.xAxis) == null ? void 0 : fe.max;
    if (X === void 0 || $ === void 0) {
      const K = L.series ?? [];
      let ae = Number.POSITIVE_INFINITY, ee = Number.NEGATIVE_INFINITY;
      for (const te of K)
        if (te.type !== "pie")
          if (te.type === "candlestick") {
            const be = te.data;
            for (const le of be) {
              const ye = _d(le);
              ye < ae && (ae = ye), ye > ee && (ee = ye);
            }
          } else {
            const be = te.data;
            for (const le of be) {
      ...
      X === void 0 && (X = Number.isFinite(ae) ? ae : 0), $ === void 0 && ($ = Number.isFinite(ee) ? ee : 100);
    }
    const ue = t.getZoomRange();
    if (ue) {
      const K = $ - X, ae = X + ue.start / 100 * K, ee = X + ue.end / 100 * K;
      return { min: ae, max: ee };
    }
    return { min: X, max: $ };
  }, I = () => {
    var ue, ce;
    const L = t.options;
    let X = (ue = L.yAxis) == null ? void 0 : ue.min, $ = (ce = L.yAxis) == null ? void 0 : ce.max;
    if (X === void 0 || $ === void 0) {
      const fe = L.series ?? [];
      let K = Number.POSITIVE_INFINITY, ae = Number.NEGATIVE_INFINITY;
      for (const ee of fe)
        if (ee.type !== "pie")
          if (ee.type === "candlestick") {
            const te = ee.data;
            for (const be of te) {
              const le = io(be) ? be[3] : be.low, ye = io(be) ? be[4] : be.high;
              le < K && (K = le), ye > ae && (ae = ye);
            }
          } else {
            const te = ee.data;
            for (const be of te) {
              const le = Ld(be);
              le < K && (K = le), le > ae && (ae = le);
            }
          }
      X === void 0 && (X = Number.isFinite(K) ? K : 0), $ === void 0 && ($ = Number.isFinite(ae) ? ae : 100);
    }
    return { min: X, max: $ };
  }, N = (L) => {
    const X = o.getBoundingClientRect(), $ = t.options.grid ?? $t, ue = X.width - ($.left ?? $t.left) - ($.right ?? $t.right), ce = v(), fe = ue > 0 ? L / ue : 0;
    return ce.min + fe * (ce.max - ce.min);
  }, C = (L, X) => {
    const $ = o.getBoundingClientRect(), ue = t.options.grid ?? $t, ce = $.width - (ue.left ?? $t.left) - (ue.right ?? $t.right), fe = $.height - (ue.top ?? $t.top) - (ue.bottom ?? $t.bottom), K = ce > 0 ? L / ce : 0, ae = fe > 0 ? X / fe : 0;
    return { x: K, y: ae };
  }, d = () => {
    if (!m) return;
    const { match: L, isInGrid: X, gridX: $ } = m;
    let ue;
    if (L)
      ue = L.value[0];
    else if (X)
    ...
    if (!m) return;
    const { match: L, isInGrid: X, gridY: $ } = m;
    let ue;
    if (L)
      ue = L.value[1];
    else if (X) {
      const ce = o.getBoundingClientRect(), fe = t.options.grid ?? $t, K = ce.height - (fe.top ?? $t.top) - (fe.bottom ?? $t.bottom), ae = I(), ee = K > 0 ? 1 - $ / K : 0.5;
      ue = ae.min + ee * (ae.max - ae.min);
    } else
      return;
    l.showCreate(
      "lineY",
    ...
    if (!m) return;
    const { match: L, isInGrid: X, gridX: $, gridY: ue } = m;
    let ce, fe, K;
    if (L)
      ce = "data", fe = L.value[0], K = L.value[1];
    else if (X) {
      const ae = C($, ue);
      ce = "plot", fe = ae.x, K = ae.y;
    } else
      return;
    l.showCreate(
      "text",
    ...
    const $ = u().filter((ue, ce) => ce !== L);
    p($), y($);
  }, B = (L) => {
    if (c || L.button === 2) return;
    const X = o.getBoundingClientRect(), $ = L.clientX - X.left, ue = L.clientY - X.top, ce = f.hitTest($, ue);
    ce && (L.preventDefault(), g.startDrag(
      ce.annotationIndex,
      ce.annotation,
      L.clientX,
      L.clientY
    ...
    c || !r || (L.preventDefault(), L.stopPropagation(), x(L));
  }, z = (L) => {
    c || M && !M.contains(L.target) && w();
  }, U = (L) => {
    c || L.key === "Escape" && M && M.style.display === "block" && w();
  }, Y = () => {
    c || M && M.style.display === "block" && w();
  }, j = (L) => {
    const X = u(), $ = {
      type: "lineX",
      x: L,
    ...
    c || (c = !0, o.removeEventListener("pointerdown", B), o.removeEventListener("contextmenu", E), document.removeEventListener("click", z), document.removeEventListener("keydown", U), window.removeEventListener("scroll", Y, !0), window.removeEventListener("resize", Y), M == null || M.remove(), M = null, f.dispose(), g.dispose(), l.dispose(), s = []);
  };
  return r && (M = R(), o.addEventListener("contextmenu", E), document.addEventListener("click", z), document.addEventListener("keydown", U), window.addEventListener("scroll", Y, !0), window.addEventListener("resize", Y)), o.addEventListener("pointerdown", B), {
    addVerticalLine: j,
    addTextNote: q,
    undo: Z,
    redo: J,
...
const ro = 120, kd = 1e3 / 60, Ud = 1.5, xn = /* @__PURE__ */ new Map();
function co() {
  ...
  return xn.set(e, {
    ...
    frameTimestamps: new Float64Array(ro),
...
function xa(e, t) {
  ...
  const i = e.id, r = (o) => {
    ...
    s.frameTimestamps[s.frameTimestampIndex] = a, s.frameTimestampIndex = (s.frameTimestampIndex + 1) % ro, s.frameTimestampCount < ro && s.frameTimestampCount++, s.totalFrames++;
    let c = o - s.lastFrameTime;
    const f = 100;
    if (c > f && (c = f), s.lastFrameTime > 0 && c > kd * Ud ? (s.totalDroppedFrames++, s.consecutiveDroppedFrames++, s.lastDropTimestamp = a) : s.lastFrameTime > 0 && (s.consecutiveDroppedFrames = 0), s.lastFrameTime = o, s.dirty) {
      s.dirty = !1, s.callback(c);
      const l = xn.get(i);
...
function Vd(e) {
  const t = xn.get(e.id);
  return t && (t.rafId !== null && (cancelAnimationFrame(t.rafId), t.rafId = null), t.callback = null, t.frameHandler = null, xn.delete(e.id)), co();
}
function am(e) {
  const t = co();
  return xa(t, e);
...
class cm {
   ...
   */
  start(t) {
    this._state = xa(this._state, t);
  }
  /**
   * Stops the render loop.
   */
  stop() {
    this._state = Gd(this._state);
  }
  /**
   ...
   */
  destroy() {
    this._state = Vd(this._state);
  }
}
const Wd = 0xcbf29ce484222325n, Od = 0x100000001b3n, Xd = 0xffffffffffffffffn, $d = (e) => {
  let t = Wd;
  for (let n = 0; n < e.length; n++)
    t ^= BigInt(e.charCodeAt(n)), t = BigInt(t * Od) & Xd;
  ...
  for (let i = 0; i < t.length; i++) {
    const r = t[i];
    if (!r) continue;
    Tt(e, r.arrayStride), je(e, r.stepMode ?? "vertex");
    const o = Array.from(r.attributes ?? []);
    if (o.length === 0) {
      Qe(e, "A0");
      continue;
    }
    o.sort((s, a) => s.shaderLocation !== a.shaderLocation ? s.shaderLocation - a.shaderLocation : s.offset !== a.offset ? s.offset - a.offset : Hd(s.format, a.format)), Qe(e, "A1"), Tt(e, o.length);
    for (let s = 0; s < o.length; s++) {
      const a = o[s];
      Tt(e, a.shaderLocation), Tt(e, a.offset), je(e, a.format);
    }
  }
}, Zd = (e, t) => {
  if (!t) {
  ...
  Qe(e, "BL1"), je(e, t.color.operation), je(e, t.color.srcFactor), je(e, t.color.dstFactor), je(e, t.alpha.operation), je(e, t.alpha.srcFactor), je(e, t.alpha.dstFactor);
}, jd = (e, t) => {
  if (!t || t.length === 0) {
    Qe(e, "T0");
    return;
  }
  Qe(e, "T1"), Tt(e, t.length);
  for (let n = 0; n < t.length; n++) {
    ...
    je(e, i.format), Zd(e, i.blend);
    const r = i.writeMask ?? Yd;
    Tt(e, r);
  }
}, Kd = (e, t) => {
  ...
  je(e, n), i == null ? ba(e) : je(e, i), je(e, r), je(e, o), lo(e, s);
}, Jd = (e, t) => {
  const n = (t == null ? void 0 : t.count) ?? 1, i = (t == null ? void 0 : t.mask) ?? 4294967295, r = (t == null ? void 0 : t.alphaToCoverageEnabled) ?? !1;
  Tt(e, n), Tt(e, i), lo(e, r);
}, Hs = (e, t) => {
  if (!t) {
    Qe(e, "SF0");
    return;
  }
  Qe(e, "SF1"), je(e, t.compare), je(e, t.failOp), je(e, t.depthFailOp), je(e, t.passOp);
}, Qd = (e, t) => {
  if (!t) {
    Qe(e, "DS0");
    return;
  }
  Qe(e, "DS1"), je(e, t.format), lo(e, t.depthWriteEnabled ?? !1), je(e, t.depthCompare ?? "always"), Hs(e, t.stencilFront), Hs(e, t.stencilBack), Tt(e, t.stencilReadMask ?? 4294967295), Tt(e, t.stencilWriteMask ?? 4294967295), Tt(e, t.depthBias ?? 0), Tt(e, t.depthBiasSlopeScale ?? 0), Tt(e, t.depthBiasClamp ?? 0);
};
function lm(e) {
  const t = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map();
  let r = 0, o = 0, s = 0, a = 0, c = 0, f = 0, l = 0, g = 0, u = 0, y = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), M = 0, R = 0;
  const D = (v) => {
    const I = y.get(v);
    if (I) return I;
    const N = `ext:${++M}`;
    ...
    t.clear(), n.clear(), i.clear(), r = 0, o = 0, s = 0, a = 0, c = 0, f = 0, l = 0, g = 0, u = 0, y = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), M = 0, R = 0;
  };
  try {
    e.lost.then(() => {
      A();
    }).catch((v) => {
      typeof v == "object" && v !== null && "message" in v && console.warn("PipelineCache: device.lost promise rejected:", v), A();
    });
  } catch {
  }
  return {
    ...
    clear: A,
    getOrCreateShaderModule: (v, I) => {
      r++;
      const N = t.get(v);
      if (N)
        return o++, N;
      s++;
      const C = e.createShaderModule({ code: v, label: I });
      t.set(v, C);
      const d = `wgsl:${$d(v)}:${v.length}`;
      return y.set(C, d), C;
    },
    getOrCreateRenderPipeline: (v) => {
      a++;
      const I = v.layout ?? "auto", N = I === "auto" ? "auto" : T(I), C = v.vertex, d = v.fragment, h = [];
      Qe(h, "rp1"), Qe(h, "L"), je(h, N), Qe(h, "V"), je(h, D(C.module)), je(h, C.entryPoint ?? ""), Hr(h, C.constants), qd(h, C.buffers), Qe(h, "F"), d ? (Qe(h, "F1"), je(h, D(d.module)), je(h, d.entryPoint ?? ""), Hr(h, d.constants), jd(h, d.targets)) : Qe(h, "F0"), Qe(h, "P"), Kd(h, v.primitive), Qd(h, v.depthStencil), Qe(h, "M"), Jd(h, v.multisample);
      const F = h.join(""), S = n.get(F);
      if (S)
        return c++, S;
      f++;
      const P = e.createRenderPipeline(v);
      return n.set(F, P), P;
    },
    getOrCreateComputePipeline: (v) => {
      l++;
      const I = v.layout ?? "auto", N = I === "auto" ? "auto" : T(I), C = v.compute, d = [];
      Qe(d, "cp1"), Qe(d, "L"), je(d, N), Qe(d, "CS"), je(d, D(C.module)), je(d, C.entryPoint ?? ""), Hr(d, C.constants);
      const h = d.join(""), F = i.get(h);
      if (F)
        return g++, F;
      u++;
      const S = e.createComputePipeline(v);
      return i.set(h, S), S;
    }
  };
}
...
const dm = "1.0.0", mm = Id;
export {
  mm as ChartGPU,
  oo as GPUContext,
  rm as OptionResolver,
  cm as RenderScheduler,
  qt as candlestickDefaults,
  Sa as clearScreen,
  om as connectCharts,
  sm as createAnnotationAuthoring,
  im as createCategoryScale,
  Ad as createChart,
  Zs as createGPUContext,
  nm as createGPUContextAsync,
  yn as createLinearScale,
  lm as createPipelineCache,
  co as createRenderScheduler,
  am as createRenderSchedulerAsync,
  $f as darkTheme,
  Rt as defaultOptions,
  Fa as destroyGPUContext,
  fm as destroyPipelineCache,
  Vd as destroyRenderScheduler,
  Ks as getCanvasTexture,
  um as getPipelineCacheStats,
  Xr as getTheme,
  js as initializeGPUContext,
  Hf as lightTheme,
  zd as requestRender,
  ya as resolveOptions,
  xa as startRenderScheduler,
  Gd as stopRenderScheduler,
  dm as version
};
