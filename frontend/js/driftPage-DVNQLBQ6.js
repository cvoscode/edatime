...
import "./chunk-PHSGYAI7.js";
import "./chunk-PZ5AY32C.js";

// frontend/src/drift/driftPage.ts
var _echartsModule = null;
async function getECharts() {
  if (!_echartsModule) {
    _echartsModule = await import("./echarts-SD7KWPBA.js");
  }
  return _echartsModule;
}
var timelineTooltipFormatter = (params) => {
...
var COLOR_REF = "rgba(0,168,255,0.85)";
var COLOR_TEXT = "#D2DAF0";
var COLOR_TEXT_DIM = "#788BAE";
var COLUMN_PALETTE = ["#00D4FF", "#7CFFB2", "#FF9E7A", "#E190FF", "#FDD663", "#58D8FF", "#58C8A6"];
...
async function initDriftPage(metadata) {
  ...
  function statusSummary(failedColumns = []) {
    ...
    const warnings = [];
    if (psiWarning) warnings.push("PSI may be inflated (reference \u226710\xD7 window size)");
...
//# sourceMappingURL=driftPage-DVNQLBQ6.js.map
