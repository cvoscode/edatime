...
export function updateAnalysisZoom(startMs, endMs, sourceKind = 'user') {
    setAnalysisStatus('analysis-zoom', `Range: ${formatAnalysisTime(startMs)} → ${formatAnalysisTime(endMs)} (${sourceKind})`);
}

export function updateAnalysisYRange(min, max, sourceKind = 'user') {
...
export function updateAnalysisCursor(tsMs) {
...
export function updateAnalysisClick(payload) {
...
export function refreshZoomControlsState() {
...
export function applyViewport(view, fetchAndRender, sourceKind = 'api') {
...
export function zoomOut(fetchAndRender) {
...
export function resetZoom(fetchAndRender) {
    dbgGroup('resetZoom', () => {
        dbg('initialView', appState.initialView);
    });
...
export function bindAnalysisChartEvents() {
