...
import { correlationColor, correlationTextColor, correlationToneClass, escapeHtmlAttribute, formatScaleTick, getColorDomainMax } from './colorScale.js';

describe('heatmap color scale', () => {
    it('maps correlation direction and fitted domains deterministically', () => {
        expect(correlationColor(1)).toBe('rgb(190,18,46)');
        expect(correlationColor(-1)).toBe('rgb(35,112,180)');
