...
import { scatterStore, uiStore } from '../stores';
    ...
    try {
      switch (input.type) {
        ...
        case 'set_y_col': {
          ...
          const resp = await fetchScatterPoints(xCol, col, 500000, colorCol, sizeCol);
          ...
          setState({
            ...
            colorValues: resp.color_values,
            colorLabels: resp.color_labels,
            colorMin: resp.color_min,
            colorMax: resp.color_max,
          });
          break;
        }
        ...
        case 'set_color_col': {
          ...
          const resp = await fetchScatterPoints(xCol, yCol, 500000, col, sizeCol);
        ...
        case 'set_size_col': {
          ...
          const resp = await fetchScatterPoints(xCol, yCol, 500000, colorCol, col);
        ...
        case 'refresh_points': {
          ...
          const resp = await fetchScatterPoints(xCol, yCol, 500000, colorCol, sizeCol);
