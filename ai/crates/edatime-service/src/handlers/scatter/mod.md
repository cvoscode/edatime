...
- `ScatterPointsResponse` — `{ x: String, y: String, color: Option<String>, total_points: usize, returned_points: usize, points: Vec<[f64; 2]>, color_values: Option<Vec<f64>>, color_labels: Option<Vec<Option<String>>>, color_min: Option<f64>, color_max: Option<f64>, color_cardinality: Option<ColorCardinality>, size_values: Option<Vec<f64>>, size_min: Option<f64>, size_max: Option<f64> }`
- `ColorCardinality` — `{ used: usize, bucketed: usize }`
