 ...
 * from a content hash of the Vite manifest. The literal token is `4dc2b8fb157bb25c-202607160639`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-4dc2b8fb157bb25c-202607160639`;
