 ...
 * from a content hash of the Vite manifest. The literal token is `bb1e792c3fb924f0-202607152218`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-bb1e792c3fb924f0-202607152218`;
