 ...
 * from a content hash of the Vite manifest. The literal token is `e3b4befc110f4abb-202607152240`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-e3b4befc110f4abb-202607152240`;
