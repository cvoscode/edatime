 ...
 * from a content hash of the Vite manifest. The literal token is `57bcba4aa71aea4b-202607152156`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-57bcba4aa71aea4b-202607152156`;
