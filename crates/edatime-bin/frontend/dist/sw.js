 ...
 * from a content hash of the Vite manifest. The literal token is `f8e1c7edbc2f24fd-202607152243`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-f8e1c7edbc2f24fd-202607152243`;
