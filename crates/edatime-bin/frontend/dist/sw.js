 ...
 * from a content hash of the Vite manifest. The literal token is `586f1d0dbc844979-202607141045`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-586f1d0dbc844979-202607141045`;
