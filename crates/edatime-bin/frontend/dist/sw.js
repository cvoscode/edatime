 ...
 * from a content hash of the Vite manifest. The literal token is `8fcec1df30476bb6-202607161036`;
 * if you see it in a deployed sw.js, the build pipeline did not run.
 */

const CACHE_NAME = `edatime-runtime-8fcec1df30476bb6-202607161036`;
